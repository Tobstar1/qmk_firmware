...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(KC_CAPS, KC_GRV, KC_NUHS, LALT(KC_5), LALT(KC_6), LSFT(KC_8), LSFT(KC_9), LALT(KC_8), LALT(KC_9), KC_RBRC, KC_MINS, SGUI(KC_4), KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_MUTE, KC_MPLY, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LCTL, KC_LALT, KC_LGUI, MO(1), KC_ENT, KC_SPC, KC_BSPC, KC_RCTL, KC_RALT, KC_TRNS),
	[1] = LAYOUT(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_ESC, LSFT(KC_2), KC_HOME, KC_UP, KC_END, KC_PGUP, LALT(KC_L), KC_7, KC_8, KC_9, KC_PMNS, KC_EQL, KC_TAB, LSFT(KC_NUHS), KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, LALT(KC_N), KC_4, KC_5, KC_6, KC_PPLS, KC_NO, KC_LSFT, KC_NUBS, LSFT(KC_NUBS), LSFT(KC_7), LSA(KC_7), KC_NO, SGUI(KC_SPC), RGB_TOG, KC_0, KC_1, KC_2, KC_3, LALT(KC_7), KC_RSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_TRNS, KC_ENT, KC_SPC, KC_DEL, KC_RCTL, KC_RALT, TO(2)),
	[2] = LAYOUT(KC_CAPS, KC_GRV, KC_NUHS, RALT(KC_8), RALT(KC_9), LSFT(KC_8), LSFT(KC_9), RALT(KC_7), RALT(KC_0), KC_RBRC, KC_MINS, KC_PSCR, KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_MUTE, KC_MPLY, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LGUI, KC_LALT, KC_LCTL, MO(3), KC_ENT, KC_SPC, KC_BSPC, KC_RCTL, KC_RALT, KC_TRNS),
	[3] = LAYOUT(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_ESC, LSFT(KC_2), KC_HOME, KC_UP, KC_END, KC_PGUP, RALT(KC_Q), KC_7, KC_8, KC_9, KC_PMNS, KC_EQL, KC_TAB, LSFT(KC_NUHS), KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_NUBS, KC_4, KC_5, KC_6, KC_PPLS, KC_NO, KC_LSFT, KC_NUBS, LSFT(KC_NUBS), LSFT(KC_7), RALT(KC_MINS), KC_INS, KC_CALC, RGB_TOG, KC_0, KC_1, KC_2, KC_3, RALT(KC_NUBS), KC_RSFT, KC_LGUI, KC_LALT, KC_LCTL, KC_TRNS, KC_ENT, KC_SPC, KC_DEL, KC_RCTL, KC_RALT, TO(0))
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [3] =  { ENCODER_CCW_CW(RGB_MODE_REVERSE, RGB_MODE_FORWARD),   ENCODER_CCW_CW(RGB_VAD, RGB_VAI)  },
};
#endif
