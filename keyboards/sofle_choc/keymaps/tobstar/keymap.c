 ...
 * qmk json2c keyboards/sofle_choc/keymaps/tobstar/tobstar.json > generated.c
 * tobstar.json was generated in the online configurator https://config.qmk.fm/#/sofle_choc/LAYOUT
 */
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(KC_CAPS, KC_NO, KC_NUBS, KC_GRV, KC_NUHS, KC_AT, KC_NO, KC_RBRC, KC_EQL, KC_NO, KC_MINS, KC_PSCR, KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_MUTE, KC_MPLY, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LGUI, KC_LCTL, KC_LALT, MO(1), KC_ENT, KC_SPC, KC_BSPC, KC_RCTL, KC_RALT, KC_APP),
	[1] = LAYOUT(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_ESC, KC_NO, KC_HOME, KC_UP, KC_END, KC_PGUP, KC_NO, KC_7, KC_8, KC_9, KC_NO, KC_NO, KC_TAB, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_NO, KC_4, KC_5, KC_6, KC_NO, KC_NO, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_INS, KC_NO, KC_NO, KC_0, KC_1, KC_2, KC_3, KC_NO, KC_RSFT, KC_LGUI, KC_LCTL, KC_LALT, KC_TRNS, KC_ENT, KC_SPC, KC_DEL, KC_RCTL, KC_RALT, KC_APP)
};
// TODO: RGB Toggle on encoder press
